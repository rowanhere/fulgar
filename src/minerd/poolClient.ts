...
// Shared with the negotiated path — see watchdog.ts (extracted 2026-07-27).
export {
  WATCHDOG_STALL_MS, WATCHDOG_BOOT_GRACE_MS, WATCHDOG_RESPAWN_AFTER_STRIKES,
  WATCHDOG_INTERVAL_MS, watchdogDecision, type WatchdogAction,
} from './watchdog.js';
