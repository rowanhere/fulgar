...
| `MINER_SYNC_WORKERS` | up to `8` | Solo bootstrap verifier threads, capped by `MINER_WORKERS`. Lower this if chain download/verification hits Node heap/OOM limits; mining still uses `MINER_WORKERS` after sync. |
